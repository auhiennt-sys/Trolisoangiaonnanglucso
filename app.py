...
<div class="main-header">
    ...
    <p>Tác giả: Ấu Thị Hiền - Trường Tiểu học Quyết Tiến - ĐT: 034 4265 609</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ấu Thị Hiền - Trường Tiểu học Quyết Tiến - ĐT: 034 4265 609</div>", unsafe_allow_html=True)
